...
- [agent-stances-skiller.md](agent-stances-skiller.md): スキラー（技術最適化 + 堅牢性）
- [agent-stances-hawk.md](agent-stances-hawk.md): ホーク（ユーザ視点 + 要件拡充）
- [agent-stances-keeper.md](agent-stances-keeper.md): キーパー（セキュリティ + 法務 + 経理視点）
